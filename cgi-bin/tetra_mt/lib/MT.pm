...
#
# $Id: MT.pm.pre 1066 2007-03-23 10:33:25Z fumiakiy $
...
sub read_config {
    ...
    return $mt->error("Missing configuration file. Maybe you forgot to move mt-config.cgi-original to mt-config.cgi?") unless $cfg_file;
    if ($] >= 5.006) {
