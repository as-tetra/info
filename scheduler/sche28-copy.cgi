...
sub main {
	...
	print "<table width=\"100%\" cellspacing=\"0\" cellpadding=\"10\"><tr class=\"bar\"><td width=100 height=32 valign=top>\n";
	...
	print "<div class=top><table width=$calw><tr><td align=right><a href=\"$script?mode=admin\">[管理]</a></td></tr></table></div>\n";
	# #
